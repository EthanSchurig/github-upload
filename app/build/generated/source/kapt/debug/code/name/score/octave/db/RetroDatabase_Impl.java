    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(23) {
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoPlaylistEntity.equals(_existingPlaylistEntity)) {
          return new RoomOpenHelper.ValidationResult(false, "PlaylistEntity(code.name.score.octave.db.PlaylistEntity).\n"
                  + " Expected:\n" + _infoPlaylistEntity + "\n"
        ...
        if (! _infoSongEntity.equals(_existingSongEntity)) {
          return new RoomOpenHelper.ValidationResult(false, "SongEntity(code.name.score.octave.db.SongEntity).\n"
                  + " Expected:\n" + _infoSongEntity + "\n"
                  + " Found:\n" + _existingSongEntity);
        }
        ...
        if (! _infoHistoryEntity.equals(_existingHistoryEntity)) {
          return new RoomOpenHelper.ValidationResult(false, "HistoryEntity(code.name.score.octave.db.HistoryEntity).\n"
                  + " Expected:\n" + _infoHistoryEntity + "\n"
        ...
        if (! _infoPlayCountEntity.equals(_existingPlayCountEntity)) {
          return new RoomOpenHelper.ValidationResult(false, "PlayCountEntity(code.name.score.octave.db.PlayCountEntity).\n"
        ...
        if (! _infoBlackListStoreEntity.equals(_existingBlackListStoreEntity)) {
          return new RoomOpenHelper.ValidationResult(false, "BlackListStoreEntity(code.name.score.octave.db.BlackListStoreEntity).\n"
        ...
        if (! _infoLyricsEntity.equals(_existingLyricsEntity)) {
          return new RoomOpenHelper.ValidationResult(false, "LyricsEntity(code.name.score.octave.db.LyricsEntity).\n"
                  + " Expected:\n" + _infoLyricsEntity + "\n"
