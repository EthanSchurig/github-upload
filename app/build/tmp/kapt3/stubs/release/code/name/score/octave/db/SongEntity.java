...
public final class SongEntity implements android.os.Parcelable {
    ...
    public static final android.os.Parcelable.Creator<code.name.score.octave.db.SongEntity> CREATOR = null;
    ...
    public static final class Creator implements android.os.Parcelable.Creator<code.name.score.octave.db.SongEntity> {
        ...
        @org.jetbrains.annotations.NotNull()
        @java.lang.Override()
        public final code.name.score.octave.db.SongEntity[] newArray(int size) {
            return null;
        }
        
        @org.jetbrains.annotations.NotNull()
        @java.lang.Override()
        public final code.name.score.octave.db.SongEntity createFromParcel(@org.jetbrains.annotations.NotNull()
