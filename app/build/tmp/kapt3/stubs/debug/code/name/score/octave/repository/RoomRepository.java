...
public abstract interface RoomRepository {
    ...
    @org.jetbrains.annotations.NotNull()
    public abstract androidx.lifecycle.LiveData<java.util.List<code.name.score.octave.db.HistoryEntity>> observableHistorySongs();
    
    @org.jetbrains.annotations.NotNull()
    public abstract androidx.lifecycle.LiveData<java.util.List<code.name.score.octave.db.SongEntity>> getSongs(long playListId);
