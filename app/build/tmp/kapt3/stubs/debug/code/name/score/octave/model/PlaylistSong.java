...
public final class PlaylistSong extends code.name.score.octave.model.Song {
    ...
    public static final android.os.Parcelable.Creator<code.name.score.octave.model.PlaylistSong> CREATOR = null;
    ...
    public static final class Creator implements android.os.Parcelable.Creator<code.name.score.octave.model.PlaylistSong> {
        ...
        @org.jetbrains.annotations.NotNull()
        @java.lang.Override()
        public final code.name.score.octave.model.PlaylistSong[] newArray(int size) {
            return null;
        }
        
        @org.jetbrains.annotations.NotNull()
        @java.lang.Override()
        public final code.name.score.octave.model.PlaylistSong createFromParcel(@org.jetbrains.annotations.NotNull()
