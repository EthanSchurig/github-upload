...
import code.name.score.octave.extensions.getIntRes
import code.name.score.octave.extensions.getStringOrDefault
import code.name.score.octave.fragments.AlbumCoverStyle
import code.name.score.octave.fragments.NowPlayingScreen
import code.name.score.octave.fragments.folder.FoldersFragment
import code.name.score.octave.helper.SortOrder.*
import code.name.score.octave.model.CategoryInfo
import code.name.score.octave.transform.*
...
//        CategoryInfo(CategoryInfo.Category.Folder, false)
    ...
    fun themeResFromPrefValue(themePrefValue: String): Int {
        return when (themePrefValue) {
            ...
            "dark" -> R.style.Theme_octave
            else -> R.style.Theme_octave
        }
    }
