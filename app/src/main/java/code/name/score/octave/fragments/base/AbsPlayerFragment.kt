...
import code.name.score.octave.activities.tageditor.SongTagEditorActivity
...
import code.name.score.octave.dialogs.*
import code.name.score.octave.extensions.hide
import code.name.score.octave.extensions.whichFragment
import code.name.score.octave.fragments.ReloadType
import code.name.score.octave.fragments.player.PlayerAlbumCoverFragment
import code.name.score.octave.helper.MusicPlayerRemote
import code.name.score.octave.interfaces.IPaletteColorHolder
import code.name.score.octave.model.Song
import code.name.score.octave.model.lyrics.Lyrics
import code.name.score.octave.repository.RealRepository
import code.name.score.octave.service.MusicService
import code.name.score.octave.util.*
