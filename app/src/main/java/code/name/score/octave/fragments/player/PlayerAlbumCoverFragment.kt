...
import code.name.score.octave.adapter.album.AlbumCoverPagerAdapter
import code.name.score.octave.adapter.album.AlbumCoverPagerAdapter.AlbumCoverFragment
...
import code.name.score.octave.transform.CarousalPagerTransformer
import code.name.score.octave.transform.ParallaxPagerTransformer
