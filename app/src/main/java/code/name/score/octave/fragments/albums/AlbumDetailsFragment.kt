...
import code.name.score.appthemehelper.common.ATHToolbarActivity.getToolbarBackgroundColor
...
import code.name.score.octave.activities.tageditor.AbsTagEditorActivity
import code.name.score.octave.activities.tageditor.AlbumTagEditorActivity
import code.name.score.octave.adapter.album.HorizontalAlbumAdapter
import code.name.score.octave.adapter.song.SimpleSongAdapter
import code.name.score.octave.dialogs.AddToPlaylistDialog
import code.name.score.octave.dialogs.DeleteSongsDialog
import code.name.score.octave.extensions.*
import code.name.score.octave.fragments.base.AbsMainActivityFragment
import code.name.score.octave.glide.AlbumGlideRequest
import code.name.score.octave.glide.ArtistGlideRequest
import code.name.score.octave.glide.octaveColoredTarget
import code.name.score.octave.glide.SingleColorTarget
import code.name.score.octave.helper.MusicPlayerRemote
import code.name.score.octave.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_A_Z
import code.name.score.octave.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_DURATION
import code.name.score.octave.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_TRACK_LIST
import code.name.score.octave.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_Z_A
import code.name.score.octave.interfaces.IAlbumClickListener
import code.name.score.octave.model.Album
import code.name.score.octave.model.Artist
import code.name.score.octave.network.Result
import code.name.score.octave.network.model.LastFmAlbum
...
class AlbumDetailsFragment : AbsMainActivityFragment(R.layout.fragment_album_details),
    ...
    private fun loadArtistImage(artist: Artist) {
        ...
        ArtistGlideRequest.Builder.from(Glide.with(requireContext()), artist)
            ...
            .dontAnimate()
            .dontTransform()
            .into(object : octaveColoredTarget(artistImage) {
