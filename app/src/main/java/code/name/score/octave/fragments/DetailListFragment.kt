...
import code.name.score.octave.*
import code.name.score.octave.adapter.album.AlbumAdapter
import code.name.score.octave.adapter.artist.ArtistAdapter
import code.name.score.octave.adapter.song.ShuffleButtonSongAdapter
import code.name.score.octave.adapter.song.SongAdapter
import code.name.score.octave.db.toSong
import code.name.score.octave.extensions.dipToPix
...
import code.name.score.octave.interfaces.IArtistClickListener
