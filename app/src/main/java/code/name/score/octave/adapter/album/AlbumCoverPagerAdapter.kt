...
import code.name.score.octave.misc.CustomFragmentStatePagerAdapter
    ...
    class AlbumCoverFragment : Fragment() {
        ...
        private fun getLayoutWithPlayerTheme(): Int {
            return when (PreferenceUtil.nowPlayingScreen) {
                Blur, Circle, Color, Normal -> R.layout.fragment_album_cover
            }
        }
        ...
        private fun loadAlbumCover() {
            SongGlideRequest.Builder.from(Glide.with(requireContext()), song)
                ...
                .into(object : octaveColoredTarget(albumCover) {
