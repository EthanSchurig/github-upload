...
import code.name.score.octave.activities.DriveModeActivity;
import code.name.score.octave.activities.LicenseActivity;
import code.name.score.octave.activities.LyricsActivity;
import code.name.score.octave.activities.PlayingQueueActivity;
import code.name.score.octave.activities.UserInfoActivity;
import code.name.score.octave.activities.WhatsNewActivity;
...
public class NavigationUtil {
  ...
  private static void stockEqualizer(@NonNull Activity activity) {
