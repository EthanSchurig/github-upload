...
package code.name.score.octave.fragments.folder;
...
import code.name.score.octave.adapter.SongFileAdapter;
...
import code.name.score.octave.helper.menu.SongMenuHelper;
import code.name.score.octave.helper.menu.SongsMenuHelper;
import code.name.score.octave.interfaces.ICabHolder;
import code.name.score.octave.interfaces.ICallbacks;
import code.name.score.octave.interfaces.IMainActivityFragmentCallbacks;
import code.name.score.octave.misc.DialogAsyncTask;
import code.name.score.octave.misc.UpdateToastMediaScannerCompletionListener;
import code.name.score.octave.misc.WrappedAsyncTaskLoader;
import code.name.score.octave.model.Song;
import code.name.score.octave.util.DensityUtil;
import code.name.score.octave.util.FileUtil;
import code.name.score.octave.util.PreferenceUtil;
import code.name.score.octave.util.RetroColorUtil;
import code.name.score.octave.util.ThemedFastScroller;
import code.name.score.octave.views.BreadCrumbLayout;
import code.name.score.octave.views.ScrollingViewOnApplyWindowInsetsListener;
import me.zhanghai.android.fastscroll.FastScroller;

import static code.name.score.appthemehelper.common.ATHToolbarActivity.getToolbarBackgroundColor;
...
public class FoldersFragment extends AbsMainActivityFragment
    ...
    private void setUpTitle() {
        ...
        Spanned appName =
                HtmlCompat.fromHtml(
                        "<span  style='color:" + hexColor + ";'>Octave</span>",
