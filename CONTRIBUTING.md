...
The [issue tracker](https://github.com/EthanSchurig/octave/issues) is the preferred channel for bug reports, feature requests and submitting pull requests, but please follow these rules:
...
## License
By contributing your code, you agree to license your contribution under the [GNU General Public License](https://github.com/EthanSchurig/octave/blob/dev/LICENSE.md). 
